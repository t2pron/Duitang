...
/**
 * Created by t2porn on 2015/8/7 0007.
 * <br/>
 * 自定义动画ImageView
 */
public class AnimImageView extends ImageView {
    ...
    public void draw(Canvas canvas) {
        ...
        if (getLayoutParams().height > dp1) {
            ...
            // 文本
            if (height >= maxHeight) {
                canvas.drawText(getResources().getText(R.string.refresh_release).toString(), centerX - textWidth, 50, mPaintText);
                canvas.drawText(getResources().getText(R.string.refresh_release).toString(), centerX - textWidth, 50, mPaintText);
            } else {
                canvas.drawText(getResources().getText(R.string.refresh_down).toString(), centerX - textWidth, 50, mPaintText);
                canvas.drawText(getResources().getText(R.string.refresh_down).toString(), centerX - textWidth, 50, mPaintText);
            }
